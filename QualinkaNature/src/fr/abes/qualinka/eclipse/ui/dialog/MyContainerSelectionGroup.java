...
public class MyContainerSelectionGroup extends Composite {
	 ...
	 * @param listener
	 *                                  A listener to forward events to. Can be null
	 *                                  if no listener is required.
	 * @param allowNewContainerName
	 *                                  Enable the user to type in a new container
	 *                                  name instead of just selecting from the
	 *                                  existing ones.
	 */
	 ...
	 */
	public MyContainerSelectionGroup(Composite parent, Listener listener, String message) {
		this(parent, listener, message, true, ResourcesPlugin.getWorkspace());
	}
	 ...
	 */
	public MyContainerSelectionGroup(Composite parent, Listener listener, String message, boolean showClosedProjects,
	    Object treeRoot) {
		this(parent, listener, message, showClosedProjects, treeRoot, SIZING_SELECTION_PANE_HEIGHT,
	 ...
	 */
	public MyContainerSelectionGroup(Composite parent, Listener listener, String message, boolean showClosedProjects,
	    Object treeRoot, int heightHint, int widthHint) {
