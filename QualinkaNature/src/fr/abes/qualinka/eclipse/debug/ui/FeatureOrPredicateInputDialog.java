package fr.abes.qualinka.eclipse.debug.ui;
...
public class FeatureOrPredicateInputDialog extends Dialog {
	...
	public FeatureOrPredicateInputDialog(Shell parentShell, String dialogTitle, String[] scenarios, int nbRows) {
	...
	/**
	 * Returns the string typed into this input dialog with double-quotes
	 * backslashed
	 *
	 * @return
	 */
	public String getProtectedData() {
		return data.replaceAll(Matcher.quoteReplacement("\\"), "\\\\\\\\").replaceAll("\"", "\\\\\"");
	}
